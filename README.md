...
## [Toolchain Setup](https://docs.espressif.com/projects/esp-idf/en/stable/esp32c3/get-started/linux-macos-setup.html)
...
* Setup to the tools
  ...
  ./install.sh esp32c3
  ```
* Setup environment variables for the current shell session
  ```
  . ~/esp/esp-idf/export.sh
  ```
* Add a bash alias to `~/.bash_aliases`: `alias get_idf=". ~/esp/esp-idf/export.sh"`
